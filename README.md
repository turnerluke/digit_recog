...
**[▶ Live demo](https://digit-recog.streamlit.app/)** · Built with [Streamlit](https://streamlit.io/), TensorFlow/Keras, OpenCV, and [Altair](https://altair-viz.github.io/), and deployed on [Streamlit Community Cloud](https://streamlit.io/cloud).
